...
ENV CLICKHOUSE_EXTERNAL_HOST=${CLICKHOUSE_EXTERNAL_HOST:-clickhouse.localhost}
ENV CLICKHOUSE_INTERNAL_HOST=${CLICKHOUSE_INTERNAL_HOST:-clickhouse}
ENV CLICKHOUSE_HTTP_PORT=${CLICKHOUSE_HTTP_PORT:-8123}
